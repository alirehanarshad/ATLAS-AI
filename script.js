...
const GOOGLE_API_KEY = 'AIzaSyBmZE4dKAJbTAqAqD7hTa1kb_Ooxz7sYr8';
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/Blue_Modern_Geometric_Logo-removebg-preview.png" alt="Gemini avatar">
            <p class="message__text"></p>
